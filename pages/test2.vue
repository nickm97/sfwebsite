<template>
  ...
  * {
  ...
  .container {
    ...
    align-items: center;
    position: relative;
    touch-action: none; /* Voorkomt default touch gedrag */
    user-select: none; /* Voorkomt tekst selectie tijdens slepen */
  }
  ...
  .cards {
    ...
    height: 400px;
    margin-bottom: 20px;
    will-change: transform; /* Optimaliseert performance */
  }
  ...
  img {
    ...
    border-radius: 10px;
    object-fit: cover;
    pointer-events: none; /* Voorkomt problemen met image drag */
  }
