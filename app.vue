<template>
  ...
  <head>
    ...
    <!-- Navbar -->
    <nav class="sticky top-0 z-50 bg-white text-black px-12 py-2 flex items-center h-[70px] border-b-1 border-gray-500">
      <!-- Grid-container -->
      <div class="grid grid-cols-3 w-full items-center">
        ...
        <div class="flex items-center space-x-6 justify-end">
          ...
          <NuxtLink to="/about" class="font-standard tracking-wide text-sizeNavText hover:text-gray-400 hover:-translate-y-1 transform transition duration-300">
            ABOUT
          </NuxtLink>
          <NuxtLink to="/contact" class="font-standard tracking-wide text-sizeNavText hover:text-gray-400 hover:-translate-y-1 transform transition duration-300">
            CONTACT
          </NuxtLink>
        </div>
    ...
    <div v-if="isMenuOpen" class="sm:hidden bg-offWhite text-black flex flex-col items-center space-y-4 p-4">
      <NuxtLink to="/" @click="closeMenu" class="font-standard text-sizeNavText hover:text-gray-400">Home</NuxtLink>
      <NuxtLink to="/shoots" @click="closeMenu" class="font-standard text-sizeNavText hover:text-gray-400">Shoots</NuxtLink>
      <NuxtLink to="/portfolio" @click="closeMenu" class="font-standard text-sizeNavText hover:text-gray-400">Portfolio</NuxtLink>
      <NuxtLink to="/about" @click="closeMenu" class="font-standard text-sizeNavText hover:text-gray-400">About</NuxtLink>
      <NuxtLink to="/contact" @click="closeMenu" class="font-standard text-sizeNavText hover:text-gray-400">Contact</NuxtLink>
    </div>
